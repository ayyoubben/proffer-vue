              ...
              <div class="col-12 col-md-9 col-lg-6 col-xl-5">
                <div class="card" style="border-radius: 10px; opacity: 0.9; color:E0E0E0;">
                  <div class="card-body p-5">
                    <h2 class="text-uppercase text-center mb-5" style="color:#2F2519">Dashboard</h2>
...
import {loginAdmin} from '../../utils/admin/admin'
...
export default {
  ...
  methods: {
    handleLoginUser() {
      loginAdmin(this.email, this.password).then(res => {
