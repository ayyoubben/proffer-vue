            ...
            <div id="qbox-container">
               <form class="needs-validation" id="form-wrapper" name="form-wrapper" novalidate="">
                        ...
                        <div class="row mt-5">
                           <div class="col-lg-7 ">
                              <div class="mt-1 form-floating">   
                                 <input v-model="numRegistre" class="form-control form-control-sm" id="RegCom" name="RegCom" type="number" placeholder="Num Registre Commercial"/>
                                 <label for="RegCom">Num Registre Commerciale</label> 
                              </div>
                           </div>
                        ...
                        <div class="row mt-5">
                           <div class="col-lg-7 ">
                              <div class="mt-1 form-floating">   
                                 <input v-model="classification" class="form-control form-control-sm" id="Qualification" name="Qualification" type="text" placeholder="Qualification"/>
                                 <label for="Qualification">Classification</label> 
                              </div>
                           </div>
                           <div class="col-lg-5 col-md-12 col-sm-12 col-12">
...
<script>   
    ...
    // whenever question changes, this function will run
        ...
        created () {
            this.numRegistre = localStorage.getItem("inscNumRegistre")
            this.classification = localStorage.getItem("inscClassification")
            if((localStorage.getItem("inscNom") != null) && (localStorage.getItem("inscType") != null) && (localStorage.getItem("inscNif") != null) && (localStorage.getItem("inscNis") != null) && (localStorage.getItem("inscCasnos") != null) && (localStorage.getItem("inscCacopath") != null)) {
                this.enableBtn = true
            } else {
        ...
        methods:{
            handlePrevBtn() {
                if( this.numRegistre != undefined ) {
                    localStorage.setItem("inscNumRegistre", this.numRegistre)
                        
                }
                if( this.classification != undefined ) {
                    localStorage.setItem("inscClassification", this.classification)
                }
            ...
            handleClassificationFile() {
                ...
                if(this.classificationFile){
                    ...
                    reader.readAsDataURL(this.classificationFile);
                }
            ...
            handleNumRegistreFile() {
                ...
                if(this.numRegistreFile){
                    ...
                    this.$store.commit("setInscDocuments", this.$store.state.inscDocuments)
                    reader.readAsDataURL(this.numRegistreFile);
                }
