...
<div class="row flex-nowrap">
    ...
    <div class="col-10">
        ...
        <nav class="nav nav-borders">
            <a @click="$router.push('/profile')" class="navlink nav-link active" data-bs-toggle="tab">Edit</a>
            <a @click="$router.push('/messoumissions')" class="navlink nav-link" data-bs-toggle="tab">Mes Soumissions</a>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                <div class="card-header color-custom-1">Informations générales</div>
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-4">
                                <div class="card-header color-custom-2">Informations d’entreprise</div>
                                <div class="card-body">
                                    <form>
                                        <!-- Form Row-->
