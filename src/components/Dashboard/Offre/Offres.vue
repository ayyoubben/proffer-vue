                      ...
                      <div class="row">
                        <div class="col-12 mt-3 mb-1">
                          ...
                          <div class="align-self-center">
                            <a style="float:right; display: inline;" class="btn" @click="handleGoTocreate"><i class="icon-plus font-medium-2 float-right"></i></a>
                          </div>    
                        </div>
                      </div>
    ...
    export default {
        ...
        methods: {
            ...
            handleGoToOffer(offre) {
              ...
              this.$router.push('/dashboard/offres/offre')
            }
        }
    }
</script>
